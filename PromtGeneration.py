from config import ar_value, style_value, c_value, s_value, v_value
...
def process_and_format_line():
    ...
    formatted_message = f"/imagine prompt:{description} --ar {ar_value} --style {style_value} --c {c_value} --s {s_value} --v {v_value}"
